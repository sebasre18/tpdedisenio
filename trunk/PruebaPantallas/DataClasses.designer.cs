...
namespace TPdeDiseño
{
    ...
    partial void OnidChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Participante_Partido_Participante", Storage="_Participante", ThisKey="id_participante", OtherKey="id_participante", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnidChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Resultado_Rdo_Partido", Storage="_Resultado", ThisKey="id_rdo", OtherKey="id_rdo", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Resultado Resultado
		{
			get
			{
    ...
    partial void Onid_competenciaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_id_participante", AutoSync=AutoSync.OnInsert, DbType="SmallInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public short id_participante
		{
			get
			{
	...
	public partial class Historial_de_Resultado : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<short> _ausente;
    ...
    partial void Onid_rdoChanging(short value);
    partial void Onid_rdoChanged();
    partial void OnausenteChanging(System.Nullable<short> value);
    partial void OnausenteChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_id_historial", AutoSync=AutoSync.OnInsert, DbType="SmallInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ausente", DbType="SmallInt")]
		public System.Nullable<short> ausente
		{
			get
			{
			...
			set
			{
				...
				{
					this.OnausenteChanging(value);
					this.SendPropertyChanging();
					this._ausente = value;
					this.SendPropertyChanged("ausente");
					this.OnausenteChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Resultado_Historial_de_Resultado", Storage="_Resultado", ThisKey="id_rdo", OtherKey="id_rdo", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Resultado Resultado
		{
			get
			{
