...
namespace TPdeDiseño.Clases_de_entidad
{
    public class HistorialResultado : Resultado
    {
        ...
        //Constructor
        public HistorialResultado(short unId_resultado, int unPuntosP1, int unPuntosP2, Participante unGanador, Participante unAusente, bool unEmpate, int unaCantidad_set, List<Set> unosSets, short unId_partido, HistorialResultado unHistResultado, DateTime unaFecha_modificacion) :
